  ...
  return(
    <>
      ...
      <Paper sx={{ padding: 3, width: { xs: "60%", md: "30%" }, textAlign: "center" }} elevation={3}>
        ...
        <TextField fullWidth label="Full Name" variant="outlined" sx={{ mt: 2 }} />
        <TextField fullWidth label="Email" variant="outlined" sx={{ mt: 2 }} />
        <TextField fullWidth label="Contact" variant="outlined" sx={{ mt: 2 }} />
        <TextField fullWidth label="Address" variant="outlined" sx={{ mt: 2 }} />
        <TextField fullWidth label="Password" type="password" variant="outlined" sx={{ mt: 2 }} />
        <Button variant="contained" sx={{ mt: 3, backgroundColor: "#ff7f00" }} fullWidth>
          Sign Up
        </Button>
